  ...
  while (t < tfinal) {
    ...
    if (dims == 0) {
      ...
      ************/
      ...
      if (rank == 0) {
        gather_charge_sources(source, Te_arr, source_allranks, Te_arr_allranks);
      } else {
        send_charge_sources(source, Te_arr);
      }
      ...
      if (order == 2) {
        ...
        if (rank == 0) {
          gather_charge_sources(source, Te_arr, source_allranks,
                                Te_arr_allranks);
        } else {
          send_charge_sources(source, Te_arr);
        }
